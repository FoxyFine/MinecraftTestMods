package com.foxyfine.my_test_mod.entity.passivepet;
...
public class GSPetEntity extends ShoulderRidingEntity implements IFlyingAnimal {
    private static final DataParameter<Integer> DATA_VARIANT_ID = EntityDataManager.defineId(GSPetEntity.class, DataSerializers.INT);
    private static final Predicate<MobEntity> NOT_PARROT_PREDICATE = p_test_1_ -> p_test_1_ != null && GSPetEntity.MOB_SOUND_MAP.containsKey(p_test_1_.getType());
    ...
    public GSPetEntity(EntityType<? extends GSPetEntity> type, World worldIn) {
        super(type, worldIn);
